#############
# 11/2/19
# Script for making 8-node chain / line figures for Paper 2 
#############

library(reshape2)
library(ggplot2)

folderName <- c("Random","Bninfo","Leong", "ParentSet","Cpdag","AdaptiveChild")
Scen <- c("125","125","125","125","125","125")
...
# make column for linetype
df$fixed <- "no"
df$fixed[df$method == "Fixed.Best" | df$method == "Fixed.Worst"] <- "yes"
